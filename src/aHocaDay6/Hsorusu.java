    ...
    public static void main(String[] args) {
     ...
     ArrayList<User> register = userReg.register();
      userReg.printHappyUsers(register);
          ...
          */
        LocalDateTime zam= LocalDateTime.now();
        LocalDateTime zam1= LocalDateTime.now();
        List<String>list=new ArrayList<>();

        list.add(String.valueOf(zam1));
        list.add(String.valueOf(zam));

        System.out.println("list = " + list);



        LocalDateTime zam2= LocalDateTime.now();
